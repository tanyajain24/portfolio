        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-gray-300"> tanya.jain.cd.eee21@itbhu.ac.in</span>
              <a
                href="mailto:tanya.jain.cd.eee21@itbhu.ac.in"
                target="blank"
            ...
            >
              ...
              <span className="text-gray-300" title="decipher by letter to number :D"> +91-8690892455</span>
              <a
                href="https://api.whatsapp.com/send?text=Hi Tanya&phone=918690892455"
                target="blank"
                className="text-white font-bold underline underline-offset-2"
              >
                Send Message
            ...
            >
              <a
                href="https://www.linkedin.com/in/tanya-jain-24322b224"
                target="blank"
              >
                {" "}
                <BsLinkedin />{" "}
              ...
              <a href="https://instagram.com/__tanya__2402?igshid=MzRlODBiNWFlZA==" target="blank">
                {" "}
                <BsInstagram />{" "}
              </a>
            </div>
